...
if ($is_category_archive) {
    ...
    $archive_keywords = $current_category->name . ',助成金,補助金,申請,支援制度,' . date('Y') . '年度';
} elseif ($is_prefecture_archive) {
    $archive_title = $current_category->name . 'の助成金・補助金';
    $archive_description = $current_category->name . 'で利用できる助成金・補助金の情報をまとめています。';
    $archive_keywords = $current_category->name . ',助成金,補助金,地方自治体,支援制度,' . date('Y') . '年度';
} else {
    $archive_title = '助成金・補助金検索 | ' . date('Y') . '年度最新情報';
    $archive_description = '全国の助成金・補助金情報を検索できます。都道府県・カテゴリで絞り込んで、最適な支援制度を見つけましょう。' . date('Y') . '年度最新情報を毎日更新中。';
    $archive_keywords = '助成金,補助金,検索,申請,支援制度,中小企業,スタートアップ,' . date('Y') . '年度';
}
...
// OGP画像
$og_image = home_url('/wp-content/uploads/2025/10/名称未設定のデザイン-3.png');

// 初期表示用のグラント取得（構造化データ用）
$initial_grants_query_for_schema = new WP_Query([
    'post_type' => 'grant',
    'posts_per_page' => 10,
    'post_status' => 'publish',
    'orderby' => 'date',
...
<meta name="keywords" content="<?php echo esc_attr($archive_keywords); ?>">
...
<!-- その他のメタタグ -->
<meta name="author" content="助成金インサイト">
<meta name="copyright" content="© <?php echo date('Y'); ?> 助成金インサイト">
<meta name="language" content="Japanese">
<meta name="revisit-after" content="1 days">
<meta name="rating" content="general">
<meta name="distribution" content="global">

<main id="grant-archive" class="grant-archive-optimized" itemscope itemtype="https://schema.org/CollectionPage">
    ...
    <script type="application/ld+json">
    {
        ...
        "mainEntity": {
            ...
            "name": "<?php echo esc_js($archive_title); ?>",
            "description": "<?php echo esc_js($archive_description); ?>",
            "numberOfItems": <?php echo $initial_grants_query_for_schema->found_posts; ?>,
            "itemListElement": [
                <?php 
                if ($initial_grants_query_for_schema->have_posts()) :
                    $position = 1;
                    while ($initial_grants_query_for_schema->have_posts()) : 
                        $initial_grants_query_for_schema->the_post();
                        $grant_amount = get_post_meta(get_the_ID(), 'grant_amount', true);
                        $grant_deadline = get_post_meta(get_the_ID(), 'grant_deadline', true);
                ?>
                {
                    "@type": "ListItem",
                    ...
                    "item": {
                        ...
                        "offers": {
                            "@type": "Offer",
                            "priceCurrency": "JPY",
                            "price": "<?php echo esc_js($grant_amount); ?>"
                        }
                        <?php endif; ?>
                        <?php if ($grant_deadline): ?>,
                        "availableThrough": "<?php echo esc_js($grant_deadline); ?>"
                        <?php endif; ?>
                    }
                }<?php echo ($position < $initial_grants_query_for_schema->post_count) ? ',' : ''; ?>
                <?php 
                        $position++;
                    endwhile;
                    wp_reset_postdata();
        ...
        "potentialAction": {
            ...
            "target": {
                "@type": "EntryPoint",
                "urlTemplate": "<?php echo esc_url(home_url('/?s={search_term_string}&post_type=grant')); ?>"
            },
    ...
    <script type="application/ld+json">
    {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "助成金と補助金の違いは何ですか？",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "助成金は条件を満たせば原則受給できる支援制度で、主に厚生労働省が管轄しています。補助金は予算や採択件数に上限があり、審査により採択されます。主に経済産業省が管轄しています。"
                }
            },
            {
                "@type": "Question",
                "name": "申請から受給までどのくらい時間がかかりますか？",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "助成金・補助金の種類により異なりますが、一般的に申請から審査・採択まで1〜3ヶ月、事業実施後の報告・精算を経て、実際の受給まで合計で3〜12ヶ月程度かかります。"
                }
            },
            {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "はい、多くの助成金・補助金は個人事業主も申請可能です。ただし、制度により法人のみ対象の場合もありますので、各助成金の詳細ページで応募要件をご確認ください。"
                }
            },
            {
                "@type": "Question",
                "name": "同時に複数の助成金に申請できますか？",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "基本的には可能ですが、同一の経費に対して重複して申請することはできません。異なる事業や経費であれば、複数の助成金・補助金を併用できる場合があります。"
                }
            },
            {
                "@type": "Question",
                "name": "<?php echo date('Y'); ?>年度の最新助成金情報はどこで確認できますか？",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "当サイトでは<?php echo date('Y'); ?>年度の最新助成金・補助金情報を毎日更新しています。カテゴリや都道府県で絞り込み検索が可能で、AI検索機能を使って最適な助成金を見つけることができます。"
                }
            }
        ]
    }
    ...
    <!-- ヘッダーセクション（画像付き） -->
    <section class="archive-hero-section" itemscope itemtype="https://schema.org/WPHeader">
        <div class="hero-background">
            <!-- Performance Optimized: WebP with fallback -->
            <picture>
                <source 
                    type="image/webp" 
        ...
        <div class="container hero-content">
            <div class="hero-text-side">
                <h1 class="hero-title" itemprop="headline"><?php echo esc_html($archive_title); ?></h1>
                <p class="hero-description" itemprop="description"><?php echo esc_html($archive_description); ?></p>
    ...
    <section class="seo-content-section" itemscope itemtype="https://schema.org/Article">
        <div class="container">
            <article class="seo-content-article">
                <header class="seo-content-header">
                    <h2 class="seo-content-title" itemprop="headline">
                        <?php 
                        if ($is_category_archive) {
                            echo esc_html($current_category->name) . '助成金・補助金の活用ガイド';
                        } elseif ($is_prefecture_archive) {
                            echo esc_html($current_category->name) . 'で利用できる助成金・補助金について';
                        } else {
                            echo '助成金・補助金の基礎知識と活用方法';
                        }
                        ?>
                    </h2>
                </header>
                
                <div class="seo-content-body" itemprop="articleBody">
                    <?php if ($is_category_archive): ?>
                        <div class="seo-content-block">
                            <h3 class="seo-content-subtitle"><?php echo esc_html($current_category->name); ?>助成金の特徴</h3>
                            <p><?php echo esc_html($current_category->name); ?>に関する助成金・補助金は、事業の発展や課題解決を支援するための重要な制度です。<?php echo date('Y'); ?>年度も多くの支援制度が用意されており、要件を満たすことで資金面でのサポートを受けることができます。</p>
                        </div>
                        
                        <div class="seo-content-block">
                            <h3 class="seo-content-subtitle">申請のポイント</h3>
                            <ul class="seo-content-list">
                                <li><strong>申請要件の確認</strong>: 各助成金の対象者や対象事業を事前に確認しましょう</li>
                                <li><strong>必要書類の準備</strong>: 事業計画書や決算書など、必要な書類を早めに準備しましょう</li>
                                <li><strong>締切の管理</strong>: 申請期限を把握し、余裕を持って準備を進めましょう</li>
                                <li><strong>専門家への相談</strong>: 申請が難しい場合は、専門家のサポートを検討しましょう</li>
                            </ul>
                        </div>
                    <?php elseif ($is_prefecture_archive): ?>
                        <div class="seo-content-block">
                            <h3 class="seo-content-subtitle"><?php echo esc_html($current_category->name); ?>の助成金制度の特徴</h3>
                            <p><?php echo esc_html($current_category->name); ?>では、地域の特性や課題に応じた独自の助成金・補助金制度を設けています。国の制度に加えて、都道府県や市町村独自の支援制度も充実しており、地域企業の成長をサポートしています。</p>
                        </div>
                        
                        <div class="seo-content-block">
                            <h3 class="seo-content-subtitle">地域密着型の支援制度</h3>
                            <p><?php echo esc_html($current_category->name); ?>独自の支援制度は、地域の産業振興や雇用創出、地域課題の解決を目的としています。地域に根ざした事業展開を検討されている方は、ぜひ活用を検討してください。</p>
                        </div>
                    <?php else: ?>
                        <div class="seo-content-block">
                            <h3 class="seo-content-subtitle">助成金・補助金とは</h3>
                            <p>助成金・補助金は、国や地方自治体が企業や個人事業主の事業活動を支援するために給付する資金です。原則として返済不要であり、新規事業の立ち上げ、設備投資、人材育成、研究開発など、様々な目的に活用することができます。</p>
                        </div>
                        
                        <div class="seo-content-block">
                            <h3 class="seo-content-subtitle">助成金と補助金の違い</h3>
                            <p><strong>助成金</strong>は、主に厚生労働省が管轄し、要件を満たせば原則として受給できる制度です。一方、<strong>補助金</strong>は、主に経済産業省や地方自治体が管轄し、予算や採択件数に上限があり、審査により採択が決定されます。</p>
                        </div>
                        
                        <div class="seo-content-block">
                            <h3 class="seo-content-subtitle"><?php echo date('Y'); ?>年度の主な支援制度</h3>
                            <p><?php echo date('Y'); ?>年度も、ものづくり補助金、IT導入補助金、事業再構築補助金、小規模事業者持続化補助金など、多くの支援制度が実施されています。各制度には申請期限や要件がありますので、当サイトで最新情報を確認し、自社に最適な制度を見つけてください。</p>
                        </div>
                    <?php endif; ?>
                    
                    <div class="seo-content-block seo-content-cta">
                        <h3 class="seo-content-subtitle">当サイトの活用方法</h3>
                        <p>当サイトでは、全国の助成金・補助金情報を網羅的に掲載しています。カテゴリ検索、都道府県検索、AI検索機能を使って、あなたのビジネスに最適な支援制度を簡単に見つけることができます。<?php echo date('Y'); ?>年度の最新情報も毎日更新していますので、ぜひブックマークしてご活用ください。</p>
                    </div>
                </div>
            </article>
        </div>
    ...
    <section class="faq-section" itemscope itemtype="https://schema.org/FAQPage">
        <div class="container">
            <header class="faq-header">
                ...
                <p class="faq-description">助成金・補助金に関するよくある質問をまとめました</p>
            </header>
            
            <div class="faq-list">
                <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                    <button class="faq-question" aria-expanded="false">
                        <h3 itemprop="name">助成金と補助金の違いは何ですか？</h3>
                    ...
                    <div class="faq-answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                        <div itemprop="text">
                            <p>助成金は条件を満たせば原則受給できる支援制度で、主に厚生労働省が管轄しています。補助金は予算や採択件数に上限があり、審査により採択されます。主に経済産業省が管轄しています。</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                    <button class="faq-question" aria-expanded="false">
                        <h3 itemprop="name">申請から受給までどのくらい時間がかかりますか？</h3>
                        <svg class="faq-icon" width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"/>
                        </svg>
                    </button>
                    <div class="faq-answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                        <div itemprop="text">
                            <p>助成金・補助金の種類により異なりますが、一般的に申請から審査・採択まで1〜3ヶ月、事業実施後の報告・精算を経て、実際の受給まで合計で3〜12ヶ月程度かかります。</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                    <button class="faq-question" aria-expanded="false">
                        <h3 itemprop="name">個人事業主でも申請できますか？</h3>
                        <svg class="faq-icon" width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"/>
                        </svg>
                    </button>
                    <div class="faq-answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                        <div itemprop="text">
                            <p>はい、多くの助成金・補助金は個人事業主も申請可能です。ただし、制度により法人のみ対象の場合もありますので、各助成金の詳細ページで応募要件をご確認ください。</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                    <button class="faq-question" aria-expanded="false">
                        <h3 itemprop="name">同時に複数の助成金に申請できますか？</h3>
                        <svg class="faq-icon" width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"/>
                        </svg>
                    </button>
                    <div class="faq-answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                        <div itemprop="text">
                            <p>基本的には可能ですが、同一の経費に対して重複して申請することはできません。異なる事業や経費であれば、複数の助成金・補助金を併用できる場合があります。</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                    <button class="faq-question" aria-expanded="false">
                        <h3 itemprop="name"><?php echo date('Y'); ?>年度の最新助成金情報はどこで確認できますか？</h3>
                        <svg class="faq-icon" width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"/>
                        </svg>
                    </button>
                    <div class="faq-answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                        <div itemprop="text">
                            <p>当サイトでは<?php echo date('Y'); ?>年度の最新助成金・補助金情報を毎日更新しています。カテゴリや都道府県で絞り込み検索が可能で、AI検索機能を使って最適な助成金を見つけることができます。</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- 関連カテゴリ・都道府県リンク（内部リンク強化） -->
    <section class="related-links-section">
        <div class="container">
            <?php if (!$is_category_archive): ?>
            <div class="related-links-block">
                <h2 class="related-links-title">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>
                    </svg>
                    カテゴリから探す
                </h2>
                <nav class="related-links-grid" aria-label="カテゴリリンク">
                    <?php 
                    $link_categories = array_slice($all_categories, 0, 12);
                    foreach ($link_categories as $cat): 
                    ?>
                        <a href="<?php echo get_term_link($cat); ?>" class="related-link-item">
                            <span class="related-link-text"><?php echo esc_html($cat->name); ?></span>
                            <span class="related-link-count"><?php echo $cat->count; ?>件</span>
                        </a>
                    <?php endforeach; ?>
                </nav>
            </div>
            ...
            <div class="related-links-block">
                ...
                <nav class="related-links-grid" aria-label="都道府県リンク">
                    <?php 
                    $link_prefectures = array_slice($prefectures, 0, 12);
                    foreach ($link_prefectures as $pref): 
                        $pref_term = get_term_by('slug', $pref['slug'], 'grant_prefecture');
                        if ($pref_term):
                    ?>
                        <a href="<?php echo get_term_link($pref_term); ?>" class="related-link-item">
                            <span class="related-link-text"><?php echo esc_html($pref['name']); ?></span>
                        </a>
                    <?php 
                        endif;
                    endforeach; 
...
<!-- Performance Optimization Phase 2: Critical CSS Only -->
...
.seo-content-cta .seo-content-subtitle {
    color: #000000;
...
.related-link-item:hover .related-link-count {
    background: rgba(0, 0, 0, 0.1);
    color: #000000;
}
...
<!-- Performance Optimization Phase 2: CSS & Script Optimization -->
<script>
(function() {
    'use strict';
    
    // Performance Enhancement: Defer non-critical resources
    function deferNonCriticalResources() {
        // 1. Tailwind CSS - defer until after first paint (500ms delay)
        ...
        // 2. Google Fonts - defer stylesheet loading (300ms delay)
        setTimeout(function() {
            var fontLinks = [
        ...
        // This defers CSS for sections user hasn't scrolled to yet
        setTimeout(function() {
            // Mark that below-fold CSS is loaded
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', deferNonCriticalResources);
    } else {
...
(function() {
    ...
    function setupEventListeners() {
        ...
        // Phase 3: Event Delegation for Category Buttons
        // Optimized: 16+ individual listeners → 2 delegated listeners
        ...
        categoryContainers.forEach(container => {
            ...
            container.addEventListener('click', function(e) {
                ...
                if (!categoryValue) {
                    ...
                    toggleMultiSelectButton(btn, state.filters.category, categoryValue);
                }
        ...
        // Phase 3: Event Delegation for Prefecture Buttons
        ...
        prefectureGroups.forEach(group => {
            ...
            group.addEventListener('click', function(e) {
                ...
                if (!prefectureValue) {
                    ...
                    toggleMultiSelectButton(btn, state.filters.prefecture, prefectureValue);
                }
                ...
                if (state.filters.prefecture.length === 1) {
                    loadMunicipalities(state.filters.prefecture[0], btn.textContent.trim());
                } else {
        ...
        // Phase 3: Passive Event Listener for better scroll performance
    ...
    // Phase 3: Throttle function for scroll/resize events
    ...
    // ============================================
    // AI質問機能をアーカイブページに追加 (Lazy Loading)
    // ============================================
